...
export const Route = createFileRoute("/privacy")({
  head: () => ({ meta: [{ title: "Privacy Policy — Dencyah Events" }, { name: "description", content: "How Dencyah Events handles your information." }] }),
    ...
    <section className="bg-[var(--cream)] min-h-dvh pt-32 pb-24 px-6">
      <div className="mx-auto max-w-[760px]">
        ...
        <div className="mt-10 space-y-5 text-[var(--espresso)]/85 leading-relaxed">
          ...
          <p>For any questions about your data, write to <a className="text-[var(--amber-gold)] thread-link" href="mailto:hello@dencyahevents.com">hello@dencyahevents.com</a>.</p>
        </div>
      </div>
    </section>
  );
